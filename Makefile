...
create-pipeline-yaml: ## create yaml file for excecuting pipeline of Vertex AI
	poetry run python pipeline.py

create-and-submit-pipeline-yaml: ## create and submit yaml file for excecuting pipeline of Vertex AI
